...
public class CreatorPlusModItems {
	...
	public static final DeferredHolder<Item, Item> RECORDING_CAMERA_SPAWN_EGG = REGISTRY.register("recording_camera_spawn_egg", () -> new DeferredSpawnEggItem(CreatorPlusModEntities.RECORDING_CAMERA, -1, -1, new Item.Properties()));
