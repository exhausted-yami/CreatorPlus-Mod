...
public class ChaoticPotionItem extends Item {
	public ChaoticPotionItem() {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("Gives random effect(s) to the player."));
		list.add(Component.literal("Can also not give effect(s) to the player."));
	}
