...
public class PlayerRenderer extends HumanoidMobRenderer<PlayerEntity, HumanoidModel<PlayerEntity>> {
	...
	public ResourceLocation getTextureLocation(PlayerEntity entity) {
		return new ResourceLocation("creator_plus:textures/entities/player.png");
	}
}
