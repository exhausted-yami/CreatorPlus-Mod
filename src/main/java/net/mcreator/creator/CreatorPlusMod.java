...
@Mod("creator_plus")
public class CreatorPlusMod {
	public static final Logger LOGGER = LogManager.getLogger(CreatorPlusMod.class);
	public static final String MODID = "creator_plus";

	public CreatorPlusMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		CreatorPlusModItems.REGISTRY.register(modEventBus);
