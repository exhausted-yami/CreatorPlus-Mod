...
public class DiamondMinecartMobEntity extends PathfinderMob {
	public DiamondMinecartMobEntity(EntityType<DiamondMinecartMobEntity> type, Level world) {
		super(type, world);
		xpReward = 2;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(CreatorPlusModItems.DIAMOND_MINECART.get()));
	}
